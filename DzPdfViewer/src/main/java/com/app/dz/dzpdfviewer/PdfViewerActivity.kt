...
import com.app.dz.dzpdfviewer.util.EdgeToEdgeHelper
import com.app.dz.dzpdfviewer.util.FileUtils.createPdfDocumentUri
import com.app.dz.dzpdfviewer.util.FileUtils.fileFromAsset
import com.app.dz.dzpdfviewer.util.FileUtils.uriToFile
import com.app.dz.dzpdfviewer.util.NetworkUtil.checkInternetConnection
import com.app.dz.dzpdfviewer.util.ThemeValidator
import com.app.dz.dzpdfviewer.util.ToolbarStyle
import com.app.dz.dzpdfviewer.util.ToolbarTitleBehavior
import com.app.dz.dzpdfviewer.util.ViewerStrings
import com.app.dz.dzpdfviewer.util.ViewerStrings.Companion.getMessageForError
import com.app.dz.dzpdfviewer.util.ViewerStyle
import com.app.dz.dzpdfviewer.util.saveTo
...
class PdfViewerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun launchPdfFromUrl(
            ...
            isPDFFromPath = false
            SAVE_TO_DOWNLOADS = saveTo == com.app.dz.dzpdfviewer.util.saveTo.DOWNLOADS
            return intent
        }
